...
const SearchFilter = ({setQ, setDistrict}: SearchFilterProps) => {
  return (
    <div className='flex flex-col md:flex-row gap-2 my-4'>
        ...
        <select onChange={(e) => setDistrict(e.target.value)} className='bg-gray-50 border border-gray-300 text-gray-800 text-sm md:max-w-[200px] rounded-lg focus:border-blue-500 block w-full p-3 outline-none'>
            <option>지역 선택</option>
